...
void Prisma::PlotFPS::Sparkline(const char* id, const float* values, int count, float min_v, float max_v, int offset, const ImVec4& col, const ImVec2& size) {
...
void Prisma::PlotFPS::ShowFPSPlot() {
    ...
    Sparkline("FPS Data", m_fpsBuffer.data(), m_fpsBuffer.size(), min, max, 0, ImPlot::GetColormapColor(1), ImVec2(250, 150));
}
