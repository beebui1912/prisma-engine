...
Prisma::PipelineBlitRT::PipelineBlitRT(Diligent::RefCntAutoPtr<Diligent::ITexture> texture) {
    ...
    m_pso->GetStaticVariableByName(Diligent::SHADER_TYPE_PIXEL, "g_Texture")->Set(texture->GetDefaultView(Diligent::TEXTURE_VIEW_SHADER_RESOURCE));
...
void Prisma::PipelineBlitRT::blit() {
    ...
    contextData.immediateContext->ClearRenderTarget(pRTV, value_ptr(Define::CLEAR_COLOR), Diligent::RESOURCE_STATE_TRANSITION_MODE_TRANSITION);
