...
Prisma::PipelineSSAO::PipelineSSAO(Diligent::RefCntAutoPtr<Diligent::ITexture> normal, Diligent::RefCntAutoPtr<Diligent::ITexture> position) {
    ...
    Diligent::RefCntAutoPtr<Diligent::IShader> pVS;
    {
        ...
        ShaderCI.FilePath = "../../../Engine/Shaders/SSAOPipeline/vertex.glsl";
    ...
    Diligent::RefCntAutoPtr<Diligent::IShader> pPS;
    {
        ...
        ShaderCI.FilePath = "../../../Engine/Shaders/SSAOPipeline/fragment.glsl";
    ...
    Diligent::ShaderResourceVariableDesc Vars[] = {{Diligent::SHADER_TYPE_PIXEL, "normalTexture", Diligent::SHADER_RESOURCE_VARIABLE_TYPE_STATIC}};
    // clang-format on
    ...
    Diligent::ImmutableSamplerDesc ImtblSamplers[] = {{Diligent::SHADER_TYPE_PIXEL, "normalTexture", SamLinearClampDesc}, {Diligent::SHADER_TYPE_PIXEL, "positionTexture", SamLinearClampNear}};
    // clang-format on
    ...
    OmniDesc.BindFlags = Diligent::BIND_UNIFORM_BUFFER;
    ...
    m_pso->GetStaticVariableByName(Diligent::SHADER_TYPE_PIXEL, "normalTexture")->Set(normal->GetDefaultView(Diligent::TEXTURE_VIEW_SHADER_RESOURCE));
    m_pso->GetStaticVariableByName(Diligent::SHADER_TYPE_PIXEL, "positionTexture")->Set(position->GetDefaultView(Diligent::TEXTURE_VIEW_SHADER_RESOURCE));
    ...
    m_blur = std::make_unique<Prisma::Blur>(m_texture);
