...
Shockwave::Shockwave() {
    if (!shader) {
        shader = std::make_shared<Prisma::Shader>("../../../UserEngine/Shaders/ShockwavePipeline/vertex.glsl", "../../../UserEngine/Shaders/ShockwavePipeline/fragment.glsl");
    }
    shader->use();
...
void Shockwave::position(glm::vec3 position) { m_position = position; }
