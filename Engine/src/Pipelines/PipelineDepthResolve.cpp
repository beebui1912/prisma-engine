...
Prisma::PipelineDepthResolve::PipelineDepthResolve(Diligent::RefCntAutoPtr<Diligent::ITexture> texture, unsigned int samplerCount) {
    ...
    PSOCreateInfo.PSODesc.Name = "PipelineDepthResolve Render";
    ...
    Diligent::RefCntAutoPtr<Diligent::IShader> pVS;
    {
        ...
        ShaderCI.Desc.Name = "PipelineDepthResolve VS";
        ShaderCI.FilePath = "../../../Engine/Shaders/DepthResolvePipeline/vertex.glsl";
    ...
    Diligent::RefCntAutoPtr<Diligent::IShader> pPS;
    {
        ...
        ShaderCI.EntryPoint = "main";
        ShaderCI.Desc.Name = "PipelineDepthResolve PS";
        ShaderCI.FilePath = "../../../Engine/Shaders/DepthResolvePipeline/fragment.glsl";
...
void Prisma::PipelineDepthResolve::render(Diligent::RefCntAutoPtr<Diligent::ITexture> texture) {
    auto& contextData = PrismaFunc::getInstance().contextData();

    auto color = texture->GetDefaultView(Diligent::TEXTURE_VIEW_DEPTH_STENCIL);

    contextData.immediateContext->SetRenderTargets(0, nullptr, color, Diligent::RESOURCE_STATE_TRANSITION_MODE_TRANSITION);
