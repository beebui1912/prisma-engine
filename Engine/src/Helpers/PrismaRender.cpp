...
Prisma::PrismaRender::BufferData Prisma::PrismaRender::quadBuffer() {
    if (!m_initQuad) {
        ...
        PrismaFunc::getInstance().contextData().device->CreateBuffer(VertBuffDesc, &VBData, &m_quadBufferData.vBuffer);
        ...
        PrismaFunc::getInstance().contextData().device->CreateBuffer(IndBuffDesc, &IBData, &m_quadBufferData.iBuffer);
        m_initQuad = true;
    }
...
Prisma::PrismaRender::BufferData Prisma::PrismaRender::cubeBuffer() {
    if (!m_initCube) {
        ...
        PrismaFunc::getInstance().contextData().device->CreateBuffer(VertBuffDesc, &VBData, &m_cubeBufferData.vBuffer);
        ...
        PrismaFunc::getInstance().contextData().device->CreateBuffer(IndBuffDesc, &IBData, &m_cubeBufferData.iBuffer);
        m_initCube = true;
    }
